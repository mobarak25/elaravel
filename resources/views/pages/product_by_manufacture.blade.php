...
<?php
$productsCount = count($manefacturs);
if ($productsCount > 0) {?>
    @foreach($manefacturs as $manefactur)
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        @php
                        $imgages = json_decode($manefactur->product_image);
                        foreach ($imgages as $imgage) {
                        echo "<img src='".url($imgage)."' alt=''/>";
                        }
                        @endphp
                        
                        <h2>${{$manefactur->product_price}}</h2>
                        <p>{{$manefactur->product_name}}</p>
    ...
    @endforeach
<?php } else { ?>
    <div class="content-404 notFound">
        <h1><b>OPPS!</b> We Couldn’t Find Any Product</h1>
