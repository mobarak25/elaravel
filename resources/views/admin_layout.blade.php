			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/all-manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>

						<li><a href="{{url("/add-manufacture")}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						...
						<li><a href="{{url('/add-slider')}}"><i class="icon-edit"></i><span class="hidden-tablet"> Slider</span></a></li>
